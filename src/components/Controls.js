    ...
    <div className="controls">
      ...
      <div className="positionControlGroup">
        <div className="xControl">
          ...
          <input type="number" min="-100" max="100" onChange={handleXPositionChange} step="any"/>
        </div>
        <div className="yControl">
          <label> Y Position </label>
          <input type="number" min="-100" max="100" onChange={handleYPositionChange} step="any"/>
        </div>
        <div className="zControl">
          <label> Z Position </label>
          <input type="number" min="-100" max="100" onChange={handleZPositionChange} step="any"/>
        </div>
      </div>
      ...
      <div className="rotationControlGroup">
        <div className="xControl">
          ...
          <input type="number" min="-180" max="180" onInput={handleXRotationChange} step="any"/>
        </div>
        <div className="yControl">
          <label> Y Rotation </label>
          <input type="number" min="-180" max="180" onInput={handleYRotationChange} step="any"/>
        </div>
        <div className="zControl">
          <label> Z Rotation </label>
          <input type="number" min="-180" max="180" onInput={handleZRotationChange} step="any"/>
        </div>
      </div>
    </div>
  );
